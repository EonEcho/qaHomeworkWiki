class Animal {
  ...
  class Fish extends Animal {
    ...
    saltwater: boolean;
    food: string;
    constructor(name: string, saltwater: boolean, food:string) {
        super(name,null, food );
        this.saltwater = saltwater;

    };
    soundOff(): string {
        return `The ${this.name} is a Fish that does not make sounds.` ;
  ...
  */
  class Bird extends Animal {
    ...
    fly(): string {
        ...
        return `The ${this.name} Flies at speeds up to ${this.flightspeed} meters per second!!`;
